              ...
              <form method="POST" action="{{ route('clientOrders.store') }}">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="user" @error('user') is-invalid @enderror id="user" required>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-12">
    <div class="input-group mb-3">
        ...
        <input type="float" name="money" class="form-control form-control-lg @error('money') is-invalid @enderror" placeholder="Enter Amount" />
      </div>
        @error('money')
        <span class="invalid-feedback" role="alert">
        <strong>{{ $message }}</strong>
