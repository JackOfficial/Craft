 ...
 <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <strong><i class="fas fa-check"></i></strong> {{ Session::get('deleteSocialmediaSuccess') }} </div>
          @elseif(Session::has('deleteSocialmediaFail'))
          <div class="alert alert-danger alert-dismissible mb-2" style="margin: 5px 5px 0px 5px;">
          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> 
          <strong>FAILED:</strong> {{ Session::get('deleteSocialmediaFail') }} </div> 
            @endif

            <div class="card">
              <div class="card-header">
                <h3 class="card-title">{{ $socialmediaCounter }} Social Media</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
